...
# USO DE MÁSCARAS RASTER PARA FILTRAR PIXELES
...
# También se puede usar la función `mask()`
mask(elev, rmask)
...
# - Podemos realizar subsetting en datos raster usando índices, 
#coordenadas y otro raster.
# - Las máscaras raster nos permiten filtrar valores en base a 
#condiciones lógicas.
# - `terra::extract()` permite extraer valores desde coordenadas o
#máscaras.
...
# La imagen 'landsat.tif' se encuentra en el paquete 'spDataLarge'.
...
# Los datos de Landsat 8 nivel-2 están almacenados como enteros, por lo
#que debemos convertirlos a valores de punto flotante aplicando un 
#factor de escala (0.0000275) y un offset (-0.2). 
#Esto ajusta los valores al rango (aprox) 0 a 1.
...
# - A diferencia de las funciones "locales" que operan sobre cada celda de
#   forma independiente (cell-by-cell), las "operaciones focales" toman en cuenta 
